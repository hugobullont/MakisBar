 ...
 * @author Usuario
 */
@WebServlet(name = "UpdateComplements", urlPatterns = {"/UpdateComplements"})
public class UpdateComplements extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateComplements</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateComplements at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            RelRestCmp temp = listComps.get(i);
            productRepo.UpdateComplementsStock(cUser.getRestaurants().getIdRestaurant(),Integer.valueOf(msu[i]),temp.getComplements().getIdComplement());
        }
